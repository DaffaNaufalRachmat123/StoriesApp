...
object MediaFolderLoader {
    ...
    private fun getSelection(): String {
        return if (beforeAndroidTen()) SELECTION_FOR_SINGLE_MEDIA_TYPE else SELECTION_FOR_SINGLE_MEDIA_TYPE_29
    }
    ...
    private const val ALBUM_NAME_ALL = "Semua Foto"

    @JvmStatic
    fun load(context: Context): Cursor {
        val albums = ContentResolverCompat.query(
